# ==============================================================================
# SCRIPT: 020_PNAD_Anual_Manual_Import_2001_2015.R
#
# OBJETIVO / PURPOSE:
#   Baixar e importar microdados da PNAD Anual (2001-2015) lendo diretamente
#   os dicionários de importação SAS originais do IBGE para evitar bugs de 
#   pacotes de terceiros (como microdadosBrasil).
#
...
output_file <- file.path(OUTPUT_DIR, "PNAD_Anual_2001_2015.parquet")
