...
# ── CONFIGURAÇÃO ───────────────────────────────────────────────────────────────
# MODO fixo: este script gera UMA figura. As outras tres variantes vivem
# em 245E (18-64), 245F (ens_sup_a 18-24) e 245G (ens_sup_a 18-64) — ver
# a nota de cabecalho delas para o motivo da separacao (2026-08-09).
MODO <- "ens_sup_18_24"
